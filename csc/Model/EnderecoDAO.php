...
class EnderecoDAO
{
    ...
    public function add(Endereco $endereco)
    {
        ...
        $query = "INSERT INTO enderecos (logradouro, numero, complemento,reg_data) VALUES(?,?,?,?)";         
        $stmt=mysqli_prepare($this->db->getConection(), $query);
		...
		$bp = mysqli_stmt_bind_param($stmt,'ssss', $logradouro, $numero, $complemento,$data_reg);
		    if(false===$bp){
    ...
    public function update(Endereco $endereco){
        ...
        $query = "UPDATE enderecos SET logradouro = ?, numero=?, complemento=?, reg_data=?  WHERE id = ?"; 
        ...
        $bp = mysqli_stmt_bind_param($stmt,'sssss', $logradouro, $numero, $complemento,$data_reg,$id);
            if(false===$bp){
                die('Error with bind_param: ') . htmlspecialchars($stmt->error);
            }
